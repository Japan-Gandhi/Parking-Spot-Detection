...
def checkSpotAvailability(imgThreshhold):
    ...
    global occupiedSpotCount, emptySpotCount
    ...
    for pos in positionList:
        ...
        if nonZeroCount > 300:
            ...
            # Saving the file
            cv.imwrite(occFileName, frame[yCord:yCord +height + 1, xCord: xCord + width + 1])
            occupiedSpotCount += 1
            ...
            # Saving the file
            cv.imwrite(empFileName, frame[yCord:yCord +height + 1, xCord: xCord + width + 1])
            emptySpotCount += 1
